                              ...
                              InkWell(
                                onTap: () async{
                                  try{
                                    ...
                                    orderController.addOrder(cartController.cartItem, cartController.totalAmount,cartController.itemCount,position);
                                    cartController.clearCart();
                                    Get.off(OrderScreen(height: widget.height,width: widget.width,));
                                  }
                                  catch (e) {
                                    Get.snackbar("Location Service & Permission Required","Allow for proceeding to next");
                                  }
                                },
                                child: Container(
                                  height: 30,
